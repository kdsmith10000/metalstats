...
import { ArrowLeft, BarChart3, TrendingUp, TrendingDown, Shield, Database, Activity, Scale, Truck } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col">
      ...
      <main className="flex-1 w-full px-6 py-12 flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10 w-full max-w-3xl">
            ...
            <div className="p-5 border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 rounded-lg">
              ...
              <p className="text-sm text-slate-600 dark:text-slate-300">
                ...
                <Link href="/delivery" className="underline">Learn more</Link>.
              </p>
            </div>
        ...
        <div className="overflow-x-auto border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 rounded-lg mb-10 w-full max-w-3xl">
            <table className="w-full text-left min-w-[480px]">
              <thead className="bg-slate-100 dark:bg-slate-800">
                <tr>
                  <th className="px-3 sm:px-5 py-3 text-xs sm:text-sm font-bold uppercase tracking-wider text-slate-700 dark:text-slate-200 w-[70px] sm:w-[100px]">Symbol</th>
                  <th className="px-3 sm:px-5 py-3 text-xs sm:text-sm font-bold uppercase tracking-wider text-slate-700 dark:text-slate-200">Metal</th>
                  <th className="px-3 sm:px-5 py-3 text-xs sm:text-sm font-bold uppercase tracking-wider text-slate-700 dark:text-slate-200">Contract Size</th>
                  <th className="px-3 sm:px-5 py-3 text-xs sm:text-sm font-bold uppercase tracking-wider text-slate-700 dark:text-slate-200">Category</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-200 dark:divide-slate-800 text-sm">
                <tr>
                  <td className="px-3 sm:px-5 py-3 font-bold text-amber-500">GC</td>
                  <td className="px-3 sm:px-5 py-3 font-semibold text-slate-900 dark:text-white">Gold</td>
                  <td className="px-3 sm:px-5 py-3 text-slate-600 dark:text-slate-300">100 troy oz</td>
                  <td className="px-3 sm:px-5 py-3 text-slate-500">Precious Metal</td>
                </tr>
                <tr>
                  <td className="px-3 sm:px-5 py-3 font-bold text-slate-400">SI</td>
                  <td className="px-3 sm:px-5 py-3 font-semibold text-slate-900 dark:text-white">Silver</td>
                  <td className="px-3 sm:px-5 py-3 text-slate-600 dark:text-slate-300">5,000 troy oz</td>
                  <td className="px-3 sm:px-5 py-3 text-slate-500">Precious Metal</td>
                </tr>
                <tr>
                  <td className="px-3 sm:px-5 py-3 font-bold text-violet-400">PL</td>
                  <td className="px-3 sm:px-5 py-3 font-semibold text-slate-900 dark:text-white">Platinum</td>
                  <td className="px-3 sm:px-5 py-3 text-slate-600 dark:text-slate-300">50 troy oz</td>
                  <td className="px-3 sm:px-5 py-3 text-slate-500">Precious Metal</td>
                </tr>
                <tr>
                  <td className="px-3 sm:px-5 py-3 font-bold text-violet-500">PA</td>
                  <td className="px-3 sm:px-5 py-3 font-semibold text-slate-900 dark:text-white">Palladium</td>
                  <td className="px-3 sm:px-5 py-3 text-slate-600 dark:text-slate-300">100 troy oz</td>
                  <td className="px-3 sm:px-5 py-3 text-slate-500">Precious Metal</td>
                </tr>
                <tr>
                  <td className="px-3 sm:px-5 py-3 font-bold text-orange-500">HG</td>
                  <td className="px-3 sm:px-5 py-3 font-semibold text-slate-900 dark:text-white">Copper</td>
                  <td className="px-3 sm:px-5 py-3 text-slate-600 dark:text-slate-300">25,000 lbs</td>
                  <td className="px-3 sm:px-5 py-3 text-slate-500">Base Metal</td>
                </tr>
                <tr>
                  <td className="px-3 sm:px-5 py-3 font-bold text-slate-500">ALI</td>
                  <td className="px-3 sm:px-5 py-3 font-semibold text-slate-900 dark:text-white">Aluminum</td>
                  <td className="px-3 sm:px-5 py-3 text-slate-600 dark:text-slate-300">44,000 lbs</td>
                  <td className="px-3 sm:px-5 py-3 text-slate-500">Base Metal</td>
                </tr>
              </tbody>
            </table>
        ...
        <div className="overflow-x-auto border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 rounded-lg mb-10 w-full max-w-3xl">
            <table className="w-full text-left min-w-[520px]">
              <thead className="bg-slate-100 dark:bg-slate-800">
                <tr>
                  <th className="px-3 sm:px-5 py-3 text-xs sm:text-sm font-bold uppercase tracking-wider text-slate-700 dark:text-slate-200 w-[160px] sm:w-[200px]">Signal</th>
                  <th className="px-3 sm:px-5 py-3 text-xs sm:text-sm font-bold uppercase tracking-wider text-slate-700 dark:text-slate-200">What It Means for Precious Metals</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-200 dark:divide-slate-800">
                <tr>
                  ...
                  <td className="px-3 sm:px-5 py-3 sm:py-4 text-sm text-slate-600 dark:text-slate-300">
                ...
                <tr>
                  <td className="px-3 sm:px-5 py-3 sm:py-4">
                    <span className="inline-flex items-center gap-2 text-amber-500 font-semibold text-sm">
