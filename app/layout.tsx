      ...
      },
      {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            position: 4,
            name: 'Blog',
            item: 'https://heavymetalstats.com/blog',
          },
        ],
      },
      {
        '@type': 'SiteNavigationElement',
        name: ['Dashboard', 'Precious Metal Stats', 'Coverage Ratio & Paper vs Physical', 'Delivery Notices', 'Blog', 'API Documentation', 'About', 'Contact'],
        url: [
          ...
          'https://heavymetalstats.com/blog',
